  ...
  try {
    ...
    if (!likedVideo) {
      throw new ApiError(
        404,
        likedVideo,
        "No liked video found : Can no toggleLike on this video"
      );
    }
    ...
    throw new ApiError(
      500,
      error,
      "Some error  occured while toggling video: Try again later"
    );
  }
}); //DONE!
  ...
  try {
    ...
    if (!likedComment) {
      throw new ApiError(
        404,
        likedComment,
        "No liked Comment found : Can no toggleLike"
      );
    }
    ...
    throw new ApiError(
      500,
      error,
      "Some error occured while toggling your liked comment: Try again later"
    );
  }
}); //DONE!
...
const toggleTweetLike = asyncHandler(async (req, res) => {
  ...
  if (!isValidObjectId(tweetId)) {
    throw new ApiError(
      404,
      "Invalid tweetId provided : Provide valid tweet id"
    );
  }
  ...
  try {
    ...
    if (!likedTweet) {
      throw new ApiError(
        404,
        likedTweet,
        "No liked video found : Can no toggleLike on this tweet"
      );
    }
    ...
    throw new ApiError(
      500,
      error,
      "Some error occured while toggling your tweetLike: Try again later"
    );
  }
}); //DONE!
...
const getLikedVideos = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    throw new ApiError(
      500,
      error,
      "Some error occured while getting liked videos"
    );
  }
}); //DONE!
